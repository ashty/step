...
DATABASES = {
    'default': {
        ...
        'NAME': ROOT+'/step.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'cycj6&-q@3d0%jrxt^7s66(r4-p(hmvaumd#p#7w3fk0*rh=@h'
